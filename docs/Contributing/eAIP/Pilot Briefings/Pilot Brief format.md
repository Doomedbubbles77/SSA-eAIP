...
*Pilots taking part in events that depart from or arrive at “ICAO” should make themselves familiar with this briefing page as well as with all existing charts.*
...
- “ICAO” does not have a real world Delivery position but one has been created on VATSIM, particularly for busy events. If offline, contact Ground / Tower / APP for Delivery Clearance. OR “ICAO_DEL” is responsible for IFR clearances.
...
- **“ICAO”_GND / TWR** will be the Position responsible for providing push-back and taxiing instructions.
...
- Please talk about Code F restirctions / Taxi instructions.
...
- As your flight is approaching “ICAO”, please make yourself familiar with the arrival and approach procedures for “Area Name”

- All pilots expect Runway XX for landing.

- Pilots should plan for the “STAR” and the **“ILS / RNAV / VOR etc” XX.**

- On initial contact with “Airport Name”, you will be told the landing runway and the arrival.
...
- For “Area Name” Oceanic flights, you will not be required to request an Oceanic Clearance.
...
- CPDLC may be available at “Area Name” Oceanic, but its availability is up to the Controller / is not available.

- SELCAL is also available at “Area Name” Oceanic / is not available.

- SLOP (Strategic Lateral Offset Procedure) is also available at “Area Name” Oceanic / is not available.

- Please include any other relevant information as long as it relates to the headings above / remove Oceanic Ops if not avail.
